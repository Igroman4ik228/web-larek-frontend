...
Код презентера не выделен в отдельные классы и находится в основном скрипте приложения (src/index.ts)

Здесь сосредоточенна вся цепочка основных действий в программе